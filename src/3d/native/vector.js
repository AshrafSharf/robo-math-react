 ...
 * @param {Object} point - Target point in Three.js coordinates {x, y, z}
 ...
 * @param {Object} direction - Direction vector in Three.js coordinates {x, y, z}
 * @param {Object} origin - Origin point in Three.js coordinates {x, y, z} (default: {0, 0, 0})
 * @param {Object} options - Configuration options
...
/**
 * Creates a dashed vector (arrow) in 3D space using Three.js coordinates
 * @param {Object} from - Start position in Three.js coordinates {x, y, z}
 * @param {Object} to - End position in Three.js coordinates {x, y, z}
 * @param {Object} options - Configuration options
