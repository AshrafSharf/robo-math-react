/**
 * rhs_dashed_line_animator.js
 * GSAP animation methods for dashed line objects using native Three.js coordinates
 ...
 * @param {number} options.stagger - Delay between each dash (default: 0.05)
 * @param {string} options.direction - Animation direction: 'forward' or 'reverse' (default: 'forward')
 ...
 * @param {Object} options - Animation options
 * @param {number} options.duration - Animation duration (default: 2)
 * @param {string} options.ease - GSAP easing function (default: "sine.inOut")
 * @param {number} options.pulseScale - Maximum scale during pulse (default: 1.3)
 * @param {Function} options.onComplete - Callback when animation completes
 * @returns {gsap.core.Timeline} GSAP timeline
 */
