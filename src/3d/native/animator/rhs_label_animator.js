/**
 * rhs_label_animator.js
 * GSAP animation methods for label objects using native Three.js coordinates
 ...
 * @param {number} options.floatHeight - Height of the float (default: 0.2)
 ...
 * @param {string} options.direction - Slide direction: 'left', 'right', 'top', 'bottom' (default: 'left')
 * @param {number} options.distance - Slide distance (default: 2)
 * @param {Function} options.onComplete - Callback when animation completes
 * @returns {gsap.core.Tween} GSAP tween object
 */
