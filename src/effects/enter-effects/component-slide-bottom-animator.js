...
export class ComponentSlideBottomAnimator {
  ...
  fromValue(basePlayableComponent) {
    return basePlayableComponent.size.height + basePlayableComponent.position.y + 800; // should be calculated bssed on current x and width
  }
