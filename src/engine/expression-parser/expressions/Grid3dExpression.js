/**
 * Grid3dExpression - 3D Grid styling configuration
 *
 * Syntax: grid3d(c(gray)), grid3d(c(gray), s(0.5))
...
export class Grid3dExpression extends AbstractNonArithmeticExpression {
    static NAME = 'grid3d';
