/**
 * Sphere3DCommand - Command for rendering a 3D sphere
 */
...
export class Sphere3DCommand extends Base3DCommand {
    /**
     * Create a sphere3d command
     * @param {Object} graphExpression - The graph expression
     * @param {Object} shapeData - { center: {x,y,z}, radius: number }
    ...
    async doInit() {
        if (!this.graphExpression) {
            const err = new Error(common_error_messages.GRAPH_REQUIRED('sphere3d'));
        ...
        this.commandResult = this.graphContainer.diagram3d.sphere3d(
    ...
    async playSingle() {
        ...
        const effect = new Math3DShapeEffect(this.commandResult, 'sphere', { pen, camera, canvas });
        return effect.play();
    }
}
