/**
 * PerpShiftCommand - Command for rendering a perpendicular-shifted vector with animation
 *
...
export class PerpShiftCommand extends BaseCommand {
    /**
    ...
    async doInit() {
        if (!this.graphExpression) {
            const err = new Error(common_error_messages.GRAPH_REQUIRED('perpshift'));
        ...
        if (!this.originalShape) {
            throw new Error(`PerpShiftCommand: original shape '${this.originalShapeVarName}' not found in registry`);
        }
    }
