...
```
cancel(textItem, replacement, style, color)
...
| Line | Explanation |
|------|-------------|
| `cancel(sel1, "1", "u")` | Cancel "5" with up-diagonal, replace with "1" |
| `cancel(sel2, "", "d")` | Cancel "b" with down-diagonal, no replacement |
| `cancel(sel3, "", "x", "red")` | Red X through "wrong" |
| `cancel(sel4, "", "u", "red")` | Cancel all "x" occurrences in red |
| `cancel(sel5, "0", "u")` | Cancel entire fraction, replace with "0" |
