  ...
  MML.mbase.Augment({
    ...
    SVGbetterBreak: function (info, state, toplevel) {
      ...
      if (toplevel && better) {
        ...
        if (MO.SVGbetterBreak(info, state)) {
          better = false;
          index = info.index
        }
      }
...
(function () {
  window.M_MULTI_LINE_LOADER = multilineload;
}());
