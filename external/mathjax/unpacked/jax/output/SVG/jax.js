...
(function (AJAX, HUB, HTML, SVG) {
    ...
    extendDelimiterV: function (svg, H, delim, scale, font) {
      ...
      if (H > h) {
        ...
        while (k-- > 0) {
          ...
          g.setAttribute('meta', 'delimiterV');
    ...
    extendDelimiterH: function (svg, W, delim, scale, font) {
      ...
      if (W > w) {
        ...
        while (k-- > 0) {
          ...
          g.setAttribute('meta', 'delimiterH');
  ...
  var BBOX = SVG.BBOX = MathJax.Object.Subclass({
    ...
    Init: function (def) {
      ...
      this.element.setAttribute('meta', 'group');
  ...
  BBOX.ROW = BBOX.Subclass({
    Init: function () {
      ...
      this.svg = [];
      this.sh = this.sd = 0;
      this.element.setAttribute('meta', 'row');
    },
    Check: function (data) {
      var svg = data.toSVG();
      this.svg.push(svg);
  ...
  BBOX.RECT = BBOX.Subclass({
    ...
    Init: function (h, d, w, def) {
      ...
      this.element.setAttribute('meta', 'rect');
    }
  });
  ...
  BBOX.FRAME = BBOX.Subclass({
    ...
    Init: function (h, d, w, t, dash, color, def) {
      ...
      this.element.setAttribute('meta', 'frame');
    }
  });
  ...
  BBOX.HLINE = BBOX.Subclass({
    ...
    Init: function (w, t, dash, color, def) {
      ...
      this.element.setAttribute('meta', 'hline');
    }
  });
  ...
  BBOX.VLINE = BBOX.Subclass({
    ...
    Init: function (h, t, dash, color, def) {
      ...
      this.element.setAttribute('meta', 'vline');
    }
  });
  ...
  BBOX.TEXT = BBOX.Subclass({
    ...
    Init: function (scale, text, def) {
      ...
      this.element.setAttribute('meta', 'text');
    }
  });
  ...
  BBOX.NULL = BBOX.Subclass({
    Init: function () {
      ...
      this.Clean();
      this.element.setAttribute('meta', 'nullbox');
    }
  });
  ...
  BBOX.GLYPH = BBOX.Subclass({
    ...
    Init: function (scale, id, h, d, w, l, r, p) {
      ...
      this.x = this.y = 0;
      this.scale = scale;
      this.element.setAttribute('meta', id);
    }
  }, {
  ...
  HUB.Register.StartupHook("mml Jax Ready", function () {
    ...
    MML.mbase.Augment({
      ...
      toSVG: function () {
        ...
        svg.element.setAttribute('meta', 'mbase');
    ...
    MML.mo.Augment({
      toSVG: function (HW, D) {
        ...
        svg.element.setAttribute('meta', 'mo');
    ...
    MML.mn.Augment({
      ...
      toSVG: function () {
        ...
        svg.element.setAttribute('meta', 'mn');
      ...
      MML.mtext.Augment({
        toSVG: function () {
          if (SVG.config.mtextFontInherit || this.Parent().type === "merror") {
            ...
            svg.element.setAttribute('meta', 'mtext');
    ...
    MML.mspace.Augment({
      toSVG: function () {
        ...
        svg.element.setAttribute('meta', 'mspace');
    ...
    MML.mphantom.Augment({
      toSVG: function (HW, D) {
        ...
        svg.element.setAttribute('meta', 'mphantom');
    ...
    MML.mpadded.Augment({
      toSVG: function (HW, D) {
        ...
        svg.element.setAttribute('meta', 'mpadded');
    ...
    MML.mrow.Augment({
      ...
      toSVG: function (h, d) {
        ...
        svg.element.setAttribute('meta', 'mrow');
    ...
    MML.mfrac.Augment({
      toSVG: function () {
        ...
        svg.element.setAttribute('meta', 'mfrac');
    ...
    MML.mfenced.Augment({
      ...
      toSVG: function () {
        ...
        svg.element.setAttribute('meta', 'mfenced');
    ...
    MML.munderover.Augment({
      toSVG: function (HW, D) {
        ...
        svg.element.setAttribute('meta', 'munderover');
    ...
    MML.msubsup.Augment({
      toSVG: function (HW, D) {
        ...
        svg.element.setAttribute('meta', 'msubsup');
    ...
    MML.TeXAtom.Augment({
      toSVG: function (HW, D) {
        ...
        svg.element.setAttribute('meta', 'TeXAtom');
