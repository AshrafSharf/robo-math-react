...
export class ComponentSlideRightAnimator {
  ...
  fromValue(basePlayableComponent) {
    return basePlayableComponent.size.width + basePlayableComponent.position.x + 200; // should be calculated bssed on current x and width
  }
}