// Table Details Module for Volume Maximization - CBSE Exercise 63.17
 ...
 * @param {number} sheetSize - Size of the sheet (18 cm)
 * @param {number} optimalCut - The optimal cut value (3 cm)
 * @returns {Object} Table controller
 */
export function createVolumeTable(controlPanel, sheetSize = 18, optimalCut = 3) {
        ...
        <table style="width: 100%; border-collapse: collapse; font-size: 14px; color: #000000;">
            <thead>
                <tr style="border-bottom: 2px solid #ddd;">
                    <th style="padding: 4px 5px; text-align: center; font-weight: bold; font-size: 13px;">Cut x (cm)</th>
                    <th style="padding: 4px 5px; text-align: center; font-weight: bold; font-size: 13px;">Base (cm)</th>
                    <th style="padding: 4px 5px; text-align: center; font-weight: bold; font-size: 13px;">Height (cm)</th>
    ...
    function populateTable() {
        ...
        // Generate values from 0.5 to 8.5 in steps of 0.5 (for 18cm sheet)
        const startCut = 0.5;
        const endCut = 8.5;
        const step = 0.5;
