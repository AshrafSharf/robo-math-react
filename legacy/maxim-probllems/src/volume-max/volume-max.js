...
function createLessonObjects(scene, cutSize) {
    ...
    const lessonLabelFontSize = Math.round(40 * labelScaleFactor);  // Increased from 28 for better visibility
    const lessonLabelScale = 0.045 * labelScaleFactor;  // Increased from 0.03 for larger labels
