...
/**
 * Creates an angle arc between two vectors in 3D space using Three.js coordinates
 * The arc is drawn from startVector to endVector around their common origin
 * @param {Object} startVector - Start vector in Three.js coordinates {x, y, z}
 * @param {Object} endVector - End vector in Three.js coordinates {x, y, z}
...
export function arc(startVector, endVector, options = {}) {
    ...
    // Generate arc points in Three.js coordinates
    const arcPoints = [];
 ...
 * @param {Object} vertex - Vertex point (where angle is formed) in Three.js coordinates {x, y, z}
...
export function arcByThreePoints(point1, vertex, point2, options = {}) {
    ...
    // Position the group using Three.js coordinates directly
