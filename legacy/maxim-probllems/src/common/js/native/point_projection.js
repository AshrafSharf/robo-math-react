 ...
 * @param {Object} point - Point in Three.js coordinates {x, y, z}
...
export function pointProjection(point, options = {}) {
    ...
    const xyPlanePoint = new THREE.Vector3(point.x, point.y, 0);
    ...
    const xAxisPoint = new THREE.Vector3(point.x, 0, 0);
    ...
    const yAxisPoint = new THREE.Vector3(0, point.y, 0);
