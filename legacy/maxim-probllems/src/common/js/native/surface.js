 ...
 * @param {Function} surfaceFunction - Callback function (x, y) => z that defines the surface in Three.js coordinates
...
export function surface(surfaceFunction, xRange = [-2, 2], yRange = [-2, 2], options = {}) {
    ...
    for (let i = 0; i <= xSteps; i++) {
        for (let j = 0; j <= ySteps; j++) {
            // Calculate x, y in Three.js coordinates
 ...
 * @param {Function} parametricFunction - Callback (u, v) => {x, y, z} that defines the surface in Three.js coordinates
