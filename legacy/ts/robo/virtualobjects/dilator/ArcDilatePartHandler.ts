...
module robo.virtualobjects.dilator
{
    ...
    export class ArcDilatePartHandler extends  DilatePartHandler
    {
        ...
        {
            var processingCircle:ProcessingCircle = <ProcessingCircle>itransformable.dilateTransform(scaleValue,dilateAbout);
        ...
        public commitTransformableObject(itransformable:ITransformable,scaleValue:number,dilateAbout:Point):void
        {
            ...
            this.commitArc(itransformable,scaleValue,dilateAbout);
        }

        private commitArc(itransformable:ITransformable,scaleValue:number,dilateAbout:Point):void
        {
            var processingCircle:ProcessingCircle = <ProcessingCircle>itransformable.dilateTransform(scaleValue,dilateAbout);
            processingCircle =  <ProcessingCircle>processingCircle.translatePointForGraphSheetOffset(GraphSheet3D.translatePointForGraphSheetOffset);
        ...
        public directCommitTransform(itransformable:ITransformable,scaleValue:number,dilate:Point):void
        {
            this.commitArc(itransformable,scaleValue,dilate);
        }
