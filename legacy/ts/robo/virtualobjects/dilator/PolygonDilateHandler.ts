...
module robo.virtualobjects.dilator
{
    ...
    export class PolygonDilateHandler extends  DilatePartHandler
    {
        ...
        {
            var rotatedPolygon:ProcessingPolygon2D = <ProcessingPolygon2D>itransformable.dilateTransform(scaleValue,dilateAbout);
